...
contract ERC20SwapTestnet is Script {
    ...
    function run() public {
        ...
        Currency currency0 = Currency.wrap(
            address(0x5D22FD842DBd82f15A78AEb0CE948f40Acd16DAd)
        );
        Currency currency1 = Currency.wrap(
            address(0x60C3d7Dbb9Aa1412f6a8BEE6b0DA8f9c8562BD66)
        );

        ArbiterAmAmmAnyERC20Hook arbiterHook = ArbiterAmAmmAnyERC20Hook(
            0x4fdBA5052daFc91633A57e80861f47b43bf41A06
        );
