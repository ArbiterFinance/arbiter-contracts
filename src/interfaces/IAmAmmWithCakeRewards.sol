...
import {ILiquididityPerSecondTracker} from "./ILiquididityPerSecondTracker.sol";
...
/// @notice To be eligible for rewards, users must subscrbe to the pool ILiquididityPerSecondTracker::INotifier.
/// @notice ILiquididityPerSecondTracker is used to track the liquidity per second of subscribed liquidity within pools like in V3.
/// @notice The rewards are distributed to the subscribers based on the liquidity per second of the subscribed liquidity.
interface IAmAmmWithCakeRewards is
