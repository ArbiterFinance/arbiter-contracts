...
import {CLPoolManager} from "lib/pancake-v4-core/src/pool-cl/CLPoolManager.sol";
import {Vault} from "lib/pancake-v4-core/src/Vault.sol";
import {Currency} from "lib/pancake-v4-core/src/types/Currency.sol";
import {SortTokens} from "lib/pancake-v4-core/test/helpers/SortTokens.sol";
import {PoolKey} from "lib/pancake-v4-core/src/types/PoolKey.sol";
import {CLPositionManager} from "lib/pancake-v4-periphery/src/pool-cl/CLPositionManager.sol";
import {ICLPositionManager} from "lib/pancake-v4-periphery/src/pool-cl/interfaces/ICLPositionManager.sol";
import {ICLRouterBase} from "lib/pancake-v4-periphery/src/pool-cl/interfaces/ICLRouterBase.sol";
import {Planner, Plan} from "lib/pancake-v4-periphery/src/libraries/Planner.sol";
import {Actions} from "lib/pancake-v4-periphery/src/libraries/Actions.sol";
import {DeployPermit2} from "permit2/test/utils/DeployPermit2.sol";
import {IAllowanceTransfer} from "permit2/src/interfaces/IAllowanceTransfer.sol";
import {UniversalRouter, RouterParameters} from "lib/pancake-v4-universal-router/src/UniversalRouter.sol";
import {Commands} from "lib/pancake-v4-universal-router/src/libraries/Commands.sol";
import {ActionConstants} from "lib/pancake-v4-periphery/src/libraries/ActionConstants.sol";
import {LiquidityAmounts} from "lib/pancake-v4-periphery/src/pool-cl/libraries/LiquidityAmounts.sol";
...
contract CLTestUtils is DeployPermit2 {
    ...
    function decreaseLiquidity(
        ...
        Plan memory planner = Planner.init().add(
            ...
            abi.encode(tokenId, config, liquidity, 0, 0, new bytes(0))
        );
        bytes memory data = planner.finalizeModifyLiquidityWithClose(key);
        positionManager.modifyLiquidities(data, block.timestamp);
    }
